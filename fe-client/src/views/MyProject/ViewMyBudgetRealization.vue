<template>
    <v-container>
        <v-row no-gutters>
            ...
            @okClicked="onOK"
            class="view-my-budget-realization__detail">
            </form-edit-budget-realization>
...
import FormEditBudgetRealization from '@/components/MyProject/FormEditBudgetRealization';
...
.view-my-budget-realization__header {
    padding-top: 32px;
    padding-bottom: 32px;
    padding-left: 32px;
    font-size: 1.25rem;
...
.view-my-budget-realization__detail {
    border-radius: 8px;
    margin: 1% auto !important;
    width: 50%;
    height: 90%;
}
.view-my-budget-realization__input {
    padding: 10px 32px;
}
.view-my-budget-realization__btn {
    text-align: end;
    button {
        margin: 10px 32px;
    }
}
.view-my-budget-realization__container {
    padding: 24px 0px;
    box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;
    border-radius: 8px;
    max-height: 90%;
}
.view-my-budget-realization__cardText {
    flex-grow: 4;
    max-height: 90%;
    overflow-y: scroll;
}
.view-my-budget-realization__field {
    min-width: 150px;
}
...
#view-my-budget-realization {
    ...
    .view-my-budget-realization__card {
