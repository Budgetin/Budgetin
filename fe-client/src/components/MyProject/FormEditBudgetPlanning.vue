  ...
  <v-card>
    <v-card-title class="mb-5">
      ...
      <a-popconfirm
        v-if="
          form.is_active == true &&
          form.project_detail.planning.is_active == true
        "
      ...
      <a-popconfirm
        v-if="
          form.is_active == true &&
          form.project_detail.planning.is_active == false
        "
      ...
      <a-popconfirm
        ...
        class="mr-2"
      >
        <v-icon color="primary" v-if="!isNew">
    ...
    <v-card-text>
      <v-form
        ref="form"
        class="EditBudgetPlanning__form"
        lazy-validation
      ...
      >
        ...
        <v-row no-gutters>
          <v-col cols="12">
            Budget This Year <strong class="red--text">*</strong>
            <div class="EditBudgetPlanning__field">
              <v-text-field
                suffix="IDR"
        ...
        <v-row no-gutters>
          <v-col cols="12">
            Q1 <strong class="red--text">*</strong>
            <div class="EditBudgetPlanning__field">
              <v-text-field
                suffix="IDR"
                v-model="planningQ1"
        ...
        <v-row no-gutters>
          <v-col cols="12">
            Q2 <strong class="red--text">*</strong>
            <div class="EditBudgetPlanning__field">
              <v-text-field
                suffix="IDR"
                v-model="planningQ2"
        ...
        <v-row no-gutters>
          <v-col cols="12">
            Q3 <strong class="red--text">*</strong>
            <div class="EditBudgetPlanning__field">
              <v-text-field
                suffix="IDR"
                v-model="planningQ3"
        ...
        <v-row no-gutters>
          <v-col cols="12">
            Q4 <strong class="red--text">*</strong>
            <div class="EditBudgetPlanning__field">
              <v-text-field
                suffix="IDR"
                v-model="planningQ4"
    ...
    planningNominal: {
      ...
      get: function () {
        if (this.form.planning_nominal) {
          this.form.planning_nominal = this.numberWithDots(
            this.form.planning_nominal
          );
    ...
    onSubmit() {
      ...
      if (validate) {
        const payload = {
          ...
          planning_nominal: this.planningNominal
            ? parseInt(
                this.form.planning_nominal.replace(
                  /[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g,
                  ""
                )
              )
            : 0,
          planning_q1: this.planningQ1
            ? parseInt(
                this.form.planning_q1.replace(
                  /[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g,
                  ""
                )
              )
            : 0,
          planning_q2: this.planningQ2
            ? parseInt(
                this.form.planning_q2.replace(
                  /[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g,
                  ""
                )
              )
            : 0,
          planning_q3: this.planningQ3
            ? parseInt(
                this.form.planning_q3.replace(
                  /[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g,
                  ""
                )
              )
            : 0,
          planning_q4: this.planningQ4
            ? parseInt(
                this.form.planning_q4.replace(
                  /[~`!@#$%^&*()+={}\[\];:\'\"<>.,\/\\\?-_]/g,
                  ""
                )
              )
