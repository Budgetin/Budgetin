<template>
    <v-card>
        ...
        <v-card-text>
            <v-form
            ref="form"
            class="DetailProject__form"
            lazy-validation
            @submit.prevent="onSubmit">
                <v-row no-gutters>
                    <!-- PROJECT NAME -->
                    <v-col no-gutters> Project Name
                        <v-col class="d-flex" cols="12" sm="6">
                            <div class="DetailProject__field">
                                <v-text-field
                ...
                <v-row no-gutters>
                    <!-- PROJECT DESCRIPTION -->
                    <v-col no-gutters> Project Description
                        <v-col class="d-flex" cols="12" sm="6">
                            <div class="DetailProject__field">
                                <v-text-field
        ...
        <v-row no-gutters>
          <v-col cols="6">
            Due Date <strong class="red--text">*</strong>
          ...
          <!-- PRODUCT NAME -->
          <v-col cols="6">
            Send Notification <strong class="red--text">*</strong>
            <v-col class="d-flex" cols="12" sm="6">
              <div class="DetailProject__field">
                <v-select
        ...
        <v-container v-if="form.notification">
          <v-row no-gutters v-if="form.notification.id == 1">
            <v-col>
              Send to <strong class="red--text">*</strong>
              <v-col no-gutters>
                <div class="sendTo">
                  <v-select
                    :items="dataAllBiro"
        ...
        <!-- BIRO -->
        <v-col cols="6">
          Planning For <strong class="red--text">*</strong>
          <v-col class="d-flex" cols="12" sm="6">
            <div class="DetailProject__field">
              <v-text-field
                v-model="form.year"
...
.DetailProject__select {
  min-width: 500px;
}
.DetailProject__field {
  min-width: 165px;
}
.DetailProject__btn {
  text-align: end;
