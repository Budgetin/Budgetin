  ...
  <div>
    ...
    >
      <v-list nav class="px-0 mx-0">
        <v-list-item class="px-0 mx-0">
          <v-list-item-icon class="px-2">
            <img src="../assets/LogoPutih.svg" height="40px" />
          </v-list-item-icon>
          <v-list-item-title>
            <img :src="require('../assets/TextPutih.png')" height="40px" />
          </v-list-item-title>
        </v-list-item>
      </v-list>
      <v-divider></v-divider>
      <v-list shaped>
        ...
        <v-list-item link :to="'/budgetList'" replace>
          <v-list-item-icon>
            <v-icon>mdi-format-list-bulleted </v-icon>
          </v-list-item-icon>
          <v-list-item-title>Budget List</v-list-item-title>
        </v-list-item>
        <v-list-item link :to="'/projectList'" replace>
          <v-list-item-icon>
